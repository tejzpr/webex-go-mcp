...
var (
	...
	PresetMinimal = []string{
		...
		"webex_subscribe_room_messages", "webex_subscribe_mentions", "webex_subscribe_direct_messages", "webex_unsubscribe", "webex_wait_for_message", "webex_list_subscriptions",
